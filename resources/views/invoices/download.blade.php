     ...
     <div class="pcs-template ">
        ...
        <div class="pcs-template-body">
              ...
              <tbody>
                 <tr>
                    <td style="vertical-align: top; width:50%;">
                       ...
                       <span class="pcs-orgname"><b>Suposa</b></span><br>
                    ...
                    <td style="width:50%;" class="text-align-right v-top">
                       <span class="pcs-entity-title">TAX INVOICE</span><br>
                        <span id="tmp_entity_number" style="font-size: 10pt;" class="pcs-label"><b># {{ getInvoiceCombination($data['invoice']->id) }}</b></span>
                       {{-- <div style="clear:both;margin-top:20px;">
                          <span style="font-size:8pt;"><b>Balance Due</b></span><br>
                          <span style="font-size:12pt;"><b>₹605.60</b></span>
                       </div> --}}
                    </td>
                 </tr>
              </tbody>
                 ...
                 <tr>
                    <td style="width:60%;vertical-align:bottom;word-wrap: break-word;">
                       <div class="billto-section"><label style="font-size: 10pt;" class="pcs-label" id="tmp_billing_address_label">Bill To</label>
                          <br>
                           <span style="white-space: pre-wrap;" id="tmp_billing_address"><strong><span class="pcs-customer-name" id="zb-pdf-customer-detail">{{ model($data['invoice']->client, 'name') }}</span></strong>
                           {{ model($data['invoice']->client, 'address') }}
                        </span>
                       </div>
                       <div style="clear:both;width:50%;margin-top: 20px;" class="shipto-section">
                          <label style="font-size: 10pt;" id="tmp_shipping_address_label" class="pcs-label">Ship To</label>
                          <br>
                          <span style="white-space: pre-wrap;" id="tmp_shipping_address">34, Riche Street
                          Chennai
                          631603 Tamil Nadu
                          India</span>
                       </div>
                          ...
                          <tbody>
                             <tr>
                                ...
                                <td class="text-align-right">
                                   <span id="tmp_entity_date">{{ date_format(date_create($data['invoice']->date), 'd M Y') }}</span>
                                </td>
                             </tr>
                             <tr>
                                <td style="padding:5px 10px 5px 0px;font-size: 10pt;" class="text-align-right">
                             ...
                             <tr>
                                ...
                                <td class="text-align-right">
                                   <span id="tmp_due_date">{{ date_format(date_create($data['invoice']->due_date), 'd M Y') }}</span>
                                </td>
                             </tr>
                             <tr>
                                <td style="padding:5px 10px 5px 0px;font-size: 10pt;" class="text-align-right">
                                ...
                                <td class="text-align-right">
                                   <span id="tmp_ref_number">321014</span>
                                </td>
                             </tr>
                          </tbody>
                       </table>
              ...
              <thead>
                 <tr style="height:32px;">
                  @if ($data['invoice']->billing_type == 'hourly')
                     ...
                     <td style="padding: 5px 10px 5px 20px;width: 40%;text-align: left;" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                        Description
                     </td>
                     <td style="padding: 5px 10px 5px 5px;width: 20%;text-align: right;" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                        Hours
                     </td>
                     <td style="padding: 5px 10px 5px 5px;width: 20%;text-align: right;" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                        Per Hours Price
                  ...
                  @if ($data['invoice']->billing_type == 'fixed')
                     ...
                     <td style="padding: 5px 10px 5px 20px;width: 50%;text-align: left;" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                        Description
                     </td>
                     <td style="padding: 5px 10px 5px 5px;width: 45%;text-align: right;" id="" class="pcs-itemtable-header pcs-itemtable-breakword">
                        Rate
                     </td>
                  @endif
                           ...
                           @foreach ($data['invoice']->invoiceDetail as $item)                           
                              <tr class="breakrow-inside breakrow-after">
                                 ...
                                 <td rowspan="1" valign="top" style="padding: 10px 0px 10px 20px;" class="pcs-item-row">
                                    <div>
                                       <div>
                                       <span style="word-wrap: break-word;" id="tmp_item_name">{{ $item->description }}</span><br>
                                       </div>
                                    </div>
                                 </td>
                                 <td rowspan="1" valign="top" style="padding: 10px 10px 5px 10px;text-align:right;word-wrap: break-word;" class="pcs-item-row">
                  ...
                  @if ($data['invoice']->billing_type == 'fixed')
                     <tr class="breakrow-inside breakrow-after">
                        ...
                        <td rowspan="1" valign="top" style="padding: 10px 0px 10px 20px;" class="pcs-item-row">
                           <div>
                              <div>
                                 <span style="word-wrap: break-word;" id="tmp_item_name">{{ $data['invoice']->fdescription }}</span><br>
                              </div>
                           </div>
                        </td>
                        <td rowspan="1" class="pcs-item-row lineitem-column lineitem-content-right text-align-right">
                 ...
                 <table class="pcs-totals" cellspacing="0" border="0" width="100%">
                    <tbody>
                       <tr>
                           ...
                           <td id="tmp_subtotal" class="total-section-value text-align-right">{{ number_format($data['invoice']->applicable_tax_percentage, 2) }}</td>
                       </tr>
                       <tr>
                          <td class="total-section-label text-align-right">Sub Total</td>
                       <td id="tmp_subtotal" class="total-section-value text-align-right">{{ getCurrency($data['invoice']->client) }} {{ number_format($data['sub_total'], 2) }}</td>
                       </tr>
                       <tr>
                           <td class="total-section-label text-align-right"><b>Total</b></td>
                           <td id="tmp_total" class="total-section-value text-align-right"><b>{{ getCurrency($data['invoice']->client) }} {{ number_format($data['total'], 2) }}</b></td>
                       </tr>
                       {{-- <tr style="height:10px;">
                          <td class="total-section-label text-align-right">Payment Made</td>
                          <td style="color: red;" class="total-section-value text-align-right">{{ $ }}</td>
                       </tr> --}}
                       {{-- <tr style="height:40px;" class="pcs-balance">
                          <td class="total-section-label text-align-right"><b>Balance Due</b></td>
                          <td id="tmp_balance_due" class="total-section-value text-align-right"><b>₹605.60</b></td>
                       </tr> --}}
                    </tbody>
                 </table>
              </div>
           ...
           <div style="clear:both;margin-top:30px;width:100%;">
              ...
              <p style="margin-top:7px;white-space: pre-wrap;word-wrap: break-word;" class="pcs-terms">Your company's Terms and Conditions will be displayed here. You can add it in the Invoice Preferences page under Settings.</p>
           </div>
